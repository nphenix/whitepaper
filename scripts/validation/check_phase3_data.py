    ...
    for extracted_dir in extracted_dirs:
        ...
        if datajson_dir.exists():
            ...
            if json_files:
                ...
                print("  ⚠️  datajson/目录为空")
        else:
            print("  ⚠️  缺少datajson/目录 (可选)")

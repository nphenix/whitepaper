...
class VectorIndexBuilder:
        ...
        try:
            ...
            if nodes:
                ...
                if nodes_without_embedding:
                    ...
                    # 使用嵌入生成器为节点生成嵌入向量
                    nodes = self.embedding_generator.generate_embeddings(nodes)  # type: ignore[arg-type]
    ...
    def insert(
        ...
        try:
            ...
            if nodes:
                ...
                # 插入文档
                index.insert(documents=documents)  # type: ignore[call-arg]
        ...
        try:
            ...
            if ref_doc_ids:
                for ref_doc_id in ref_doc_ids:
                    index.delete_ref_doc(ref_doc_id=ref_doc_id, delete_from_docstore=delete_from_docstore)
                logger.info(
    ...
    def query(
        ...
        try:
            ...
            # 构建查询
            query_bundle = QueryBundle(query_str=query_str or "", embedding=query_embedding)
    ...
    def query_with_metadata_filter(
        ...
        try:
            ...
            filters = MetadataFilters(filters=filters_list) if filters_list else None  # type: ignore[arg-type]
